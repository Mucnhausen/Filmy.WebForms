    ...
    <div class="content">
        <div class="container">
            ...
            <div class="text-container">
                ...
                <p class="text"><span class="bold">Born on: </span><asp:Label ID="birth_date" runat="server" Text="Label"></asp:Label> | Joined on: <asp:Label ID="reg_date" runat="server" Text="Label"></asp:Label></p>
